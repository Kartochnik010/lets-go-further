...
func main() {
	...
	flag.StringVar(&cfg.smtp.host, "smtp-host", os.Getenv("SMPT_HOST"), "SMTP host")
	SMPT_PORT, _ := strconv.Atoi(os.Getenv("SMPT_PORT"))
	flag.IntVar(&cfg.smtp.port, "smtp-port", SMPT_PORT, "SMTP port")
	flag.StringVar(&cfg.smtp.username, "smtp-username", os.Getenv("SMPT_USERNAME"), "SMTP username")

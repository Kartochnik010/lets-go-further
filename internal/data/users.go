...
// Declare a new AnonymousUser variable. It's a pointer to a specific AnonymousUser,
// so, random user with no fields will not return true
...
// plaintext is a *pointer* to a string

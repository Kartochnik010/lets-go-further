...
// mail.Dialer instance to connect to a SMTP server
...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	// error.
	// Try sending the email up to three times before aborting and returning the final // error. We sleep for 500 milliseconds between each attempt.
	for i := 1; i <= 3; i++ {
